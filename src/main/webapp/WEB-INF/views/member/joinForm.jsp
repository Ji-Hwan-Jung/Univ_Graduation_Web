            ...
            <form id="fregisterform" name="joinForm" method=post  Action='join' onsubmit='return Check_Form()' >
	            <div class="row_group">
	                <div class="join_row">
	                    ...
	                    <span class="ps_box int_id">
	                        <input type="text" id="userid" name="userid" class="int" title="ID" maxlength="20" onblur="idCheck();" required>
	                        </span>
	                        <br>
	                    <span id="idMsg">필수 정보입니다.</span>
	                </div>
	            ...
	            <div class="row_group">
	                ...
	                <div class="join_row">
	                    ...
	                    <span class="ps_box box_right_space">
	                        <input type="text" id="birthday" name="birthday" title="생년월일" class="int" maxlength="40" required numeric value=''>
	                    </span>
	                </div>
	            ...
	            <div class="join_row join_mobile" id="mobDiv">
	                ...
	                <div class="join_row">
	                    <span class="ps_box int_email box_right_space">
	                        <input type="text" id="phone" name="phone" placeholder="전화번호 입력" aria-label="전화번호 입력" class="int" maxlength="16" required>
                    ...
                    <span class="ps_box int_mobile">
                        <input type="text" id="zip" name="zip" placeholder="우편번호" aria-label="우편번호" class="int" maxlength="6" required>
                        <label for="phoneNo" class="lbl"></label>
                	...
                	<div class="join_row">
	                    <span class="ps_box int_email box_right_space">
	                        <input type="text" id="addr1" name="addr1" class="int" required>
	                        <label for="phoneNo" class="lbl"></label>
	                    </span>
	                </div>
	                <div class="join_row">
	                    <span class="ps_box int_email box_right_space">
	                        <input type="text" id="addr2" name="addr2" class="int" required>
	                        <label for="phoneNo" class="lbl"></label>
	                    </span>
	                </div>
